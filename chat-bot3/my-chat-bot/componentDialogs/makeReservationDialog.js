...
class MakeReservationDialog extends ComponentDialog {
    ...
    async check(step) {
        ...
        if (myapp.flag5 == 1) {
            if (step.values.joji.toLowerCase() == 'yes') {
                ...
                var query = "INSERT INTO blt_bot_table VALUES('" + step.values.name + "', '" + step.values.power_options + "', '" + step.values.inPower + "', null, '" + step.values.equip + "', '" + step.values.ce + "', '" + step.values.rPort + "', '" + step.values.rpl + "', '" + step.values.joji + "', null, null, null)";
                ...
                return await step.context.sendActivity("Check for result and update back in SNOW");
            }
    ...
    async officeTime(step) {
        ...
        if (myapp.flag6 == 'b') {
            ...
            endDialog = true;
            var query = "INSERT INTO blt_bot_table VALUES('" + step.values.name + "', '" + step.values.power_options + "', '" + step.values.inPower + "', null, '" + step.values.equip + "', '" + step.values.ce + "', '" + step.values.rPort + "', '" + step.values.rpl + "',null,null, '" + step.values.joji[0]['value'] + "', '" + step.values.ckeck + "')";
    ...
    async confirmStep(step) {
        ...
        if (myapp.flag8 == false) {
            ...
            var query = "INSERT INTO blt_bot_table VALUES('" + step.values.name + "', '" + step.values.power_options + "', '" + step.values.inPower + "', null, '" + step.values.equip + "', '" + step.values.ce + "', '" + step.values.rPort + "', '" + step.values.rpl + "', '" + step.values.joji + "', '" + step.values.ckeck + "', '" + step.values.customerTime[0]['value'] + "', '" + step.values.noOfParticipants + "')";
            ...
            //  console.log(i);
            //}
            return await step.context.sendActivity("Thanks POE/Modem reboot ye")
        }
    }
    ...
    async findroof(step) {
        ...
        if (myapp.flag9 == true) {
            ...
            endDialog = true;
            //return await step.prompt(TEXT_PROMPT, 'Thanks');
            var query = "INSERT INTO blt_bot_table VALUES('" + step.values.name + "', '" + step.values.power_options + "', '" + step.values.inPower + "', null, '" + step.values.equip + "', '" + step.values.ce + "', '" + step.values.rPort + "', '" + step.values.rpl + "', '" + step.values.joji + "', '" + step.values.ckeck + "', '" + step.values.noOfParticipants[0]['value'] + "', '" + step.values.per + "')";
            ...
            return await step.context.sendActivity("Thanks POE/Modem reboot no")
